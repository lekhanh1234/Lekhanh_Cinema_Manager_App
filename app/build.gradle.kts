...
// Stripe
    ...
    implementation("androidx.navigation:navigation-fragment-ktx:2.8.1") // Kiểm tra phiên bản mới nhất
    implementation("androidx.navigation:navigation-ui-ktx:2.8.1") // Kiểm tra phiên bản mới nhất
